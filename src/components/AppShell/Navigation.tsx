...
export const navigation: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: CalendarClock,
    section: "MAIN",
    navigationCode: "SCHEDULED_PAYMENTS",
    subItems: [
      { label: "M&A Scheduled Payments", path: "/purchasing/recurring?filter=MA_SCHEDULED", navigationCode: "SCHEDULED_PAYMENTS" },
      { label: "All Subscriptions", path: "/purchasing/recurring", navigationCode: "SCHEDULED_PAYMENTS" },
